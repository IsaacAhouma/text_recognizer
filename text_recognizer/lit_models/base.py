"""Base Module for PyTorch Lightning Models"""
...
class BaseLitModel(pl.LightningModule):
    """Base PyTorch-Lightning class that needs to be initiliazed with a PyTorch module."""
    ...
    def add_to_argparse(parser):
        ...
        parser.add_argument("--loss", type=str, default=LOSS, help="Loss Function from torch.functional")
